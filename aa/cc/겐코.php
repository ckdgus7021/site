...
<?php include "./header.php" ?>
    ...
    <?php
include 'dbconn.php';
$sql = "SELECT round(avg(star),2), restaurant FROM star where restaurant='겐코'";
...
<?php
   ...
   from menu left join rec on menu.menu=rec.menu where menu.restaurant='겐코' group by menu.menu order by sum(recommend) desc";
   $result = mysqli_query($conn, $sql);
