...
?>
<img style="width: 130px; height: 130px; margin: 25px;" src="./img/rest/<?php echo $row['image']; ?>" class="rest_img">
   ...
   while($row = mysqli_fetch_assoc($result)) {
    ?>
     ...
     padding: 3px; color: #000; border-radius: 5px;";>&nbsp;' . $row['sum(recommend)'] .'</i></label></form>' ?></td></tr>
        <tr><td><img style="width: 50px; height: 50px;" src="./img/menu/<?php echo $row['restaurant'] . "/" . $row['image']; ?>"></td><td style="float: right;"><?php echo $row['price'] . "원"; ?></td></tr>
