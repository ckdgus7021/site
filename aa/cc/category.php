...
<head>
    ...
    <link rel="stylesheet" href="./category.css?after">
</head>


<?php
include  "./dbconn.php"; include "./session_start.php"; include "./header.php";
...
<?php
   ...
   $sql = "SELECT restaurant.*, round(avg(star),2) from restaurant left join star on restaurant.restaurant=star.restaurant where restaurant.category='$category' group by restaurant.restaurant";
