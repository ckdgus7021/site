...
<div>
    ...
    <div id="right">
        ...
        <div class="board_title" style="font-size: 22px;">소울메EAT...☆</div>
      ...
      <thead>
          <tr>
                <td class="board_top" style="font-size: 17px;"><b>제목</b></td>
                <td class="board_top2" style="font-size: 17px;"><b>작성자</b></td>
            </tr>
        </thead>
            <?php
