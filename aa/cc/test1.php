...
<div>
    ...
    <div id="right">
        ...
        <a href="/cc/board/board.php" style="text-decoration: none; -webkit-tap-highlight-color : transparent; color: black; margin-left: 13%; margin-right: 3%; font-size:15px; padding: 0;">더보기 +</a>
        </div>
